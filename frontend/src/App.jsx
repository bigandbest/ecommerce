...
import WalletDashboard from "./Pages/Wallet/WalletDashboard.jsx"; // Import Wallet component
        ...
        <>
          ...
          {location.pathname === "/" && (
            <>
              ...
              {isMobile && <StoreNav />}
              {isMobile && <Stores title="BBM Picks" items={Seconddata} />}
              {isMobile && <BbmPicks title="Recommended Store" items={data} />}
              {isMobile && <Quickyfy title="Quickyfy" items={Thirddata} />}
              <MobileCategoriesBar />
            </>
          )}
          {location.pathname !== "/" && (
