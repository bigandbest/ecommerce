...
import { Notifications as NotificationsIcon, CheckCircle, Cancel, Refresh } from '@mui/icons-material';
  ...
  const fetchReturnNotifications = async () => {
    ...
    try {
      ...
      for (const server of servers) {
        try {
          const url = `${server}/api/notifications/user/${currentUser.id}?limit=10`;
              ...
              {notifications.map((notification) => (
                <ListItem
                  ...
                  sx={{
                    ...
                    backgroundColor: notification.is_read ? 'transparent' : '#fff3e0',
                    cursor: 'pointer',
