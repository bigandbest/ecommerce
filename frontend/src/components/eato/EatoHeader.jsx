...
function EatoHeader() {
  const { currentUser, isAuthenticated, logout, userProfile, loading, error } = useAuth();
  ...
  return (
    <div className="w-full h-auto flex flex-col">
      {/* Main Header */}
      <div className="w-full h-auto flex flex-col px-3 sm:px-4 md:px-6 lg:px-8 xl:px-10 bg-gradient-to-r from-orange-500 via-yellow-500 to-orange-600 py-2 sm:py-3 md:py-4 lg:py-6 gap-2 sm:gap-3 md:gap-4 lg:gap-6">
              ...
              >
                ...
                <div>
                  <div className="flex items-center gap-1">
                    ...
                    {isLocationOpen ? (
                      <RiArrowDropUpLine className="text-xs text-white" />
                    ) : (
                      <RiArrowDropDownLine className="text-xs text-white" />
                    )}
                  </div>
                  <span className="text-[12px] leading-0 text-white/80">
                    {isLoadingLocation
                      ? "Please wait..."
          ...
          <div className="w-full h-auto lg:hidden">
            ...
            <div className="flex items-center gap-2 mb-2">
              <div
                ...
                className="flex items-center gap-2 p-2 bg-white/20 rounded-lg flex-1 cursor-pointer"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-[10px] text-white/80">Deliver to</div>
                  <div className="text-xs font-medium text-white truncate">
                    {isLoadingLocation ? "Detecting location..." : location}
                  </div>
                </div>
                <div className="text-white p-1 flex-shrink-0">
                  {isLocationOpen ? (
                    <svg
                      className="w-4 h-4"
                      fill="none"
              ...
              {isAuthenticated && (
                <Link
                  href="/pages/wallet"
                  className="p-2 bg-white/20 rounded-lg flex-shrink-0 flex items-center justify-center w-12 h-12"
                >
            ...
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <Link
                ...
                className="flex items-center gap-1 p-2 bg-white/20 rounded-lg flex-shrink-0 min-w-[65px] h-10"
              >
        ...
        <div className="w-full h-auto hidden lg:flex items-center justify-between py-3 border-b border-white/20 mb-4 px-2">
          <div className="flex items-center gap-3 sm:gap-6 lg:gap-8 overflow-x-auto">
            <Link
              href="/"
              className="text-sm font-semibold text-white py-2 px-4 bg-white/20 hover:bg-white hover:text-red-600 rounded-lg transition-all whitespace-nowrap flex items-center gap-2"
            >
            ...
            >
              <Link
                ...
                className="flex items-center gap-1 text-sm font-semibold text-white py-2 px-4 bg-white/20 hover:bg-white hover:text-red-600 rounded-lg transition-all whitespace-nowrap"
              >
                <span className="text-base">📂</span>
                Categories
            ...
            <Link
              href="/pages/contactus"
              className="font-semibold text-sm py-2 px-4 bg-white/20 hover:bg-white hover:text-red-600 rounded-lg transition-all whitespace-nowrap flex items-center gap-2"
            >
              <span className="text-base">📞</span>
              ENQUIRY
            </Link>
      ...
      {isSidebarOpen && (
        <div className="fixed inset-0 bg-black/50 bg-opacity-50 z-50 lg:hidden">
          ...
          >
            <div className="p-4 flex justify-between items-center bg-gradient-to-r from-orange-500 via-yellow-500 to-orange-600">
              {!loading && isAuthenticated ? (
            ...
            <div className="p-4">
              ...
              <nav>
                <div className="space-y-2">
                  ...
                  <Link
                    href="/pages/eato"
                    className="flex items-center gap-3 py-3 px-4 text-white bg-[#FD5B00] rounded-lg font-semibold text-sm sm:text-base transition-all"
                  >
