      ...
      <div className="w-full max-w-7xl h-auto flex items-center font-outfit bg-[#2A2A2A] rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="w-full md:w-[40%] h-[600px] flex flex-col justify-center px-8 lg:px-12 py-8">
          <div className="w-full h-auto flex flex-col gap-6 xl:gap-8">
            <h1 className="text-4xl font-bold text-[#F8F8FA] xl:text-6xl">
              Log in
            </h1>
            ...
            >
              ...
              <div className="w-full h-auto flex flex-col gap-3">
                <label
                  htmlFor="email"
                  className="text-[#F8F8FA] text-lg font-medium"
                >
                  Email Address
                </label>
                <input
              ...
              <p className="text-[#F8F8FA] text-base lg:text-lg text-center">
                <Link
                  href={"/pages/forgot-password"}
                  className="text-[#FD5B00] cursor-pointer font-semibold"
                >
                  Forgot your password?
                </Link>
              </p>

              <p className="text-[#F8F8FA] text-base lg:text-lg">
              ...
              <button
                type="submit"
                disabled={loading}
                className="bg-[#FD5B00] text-white font-bold rounded-2xl text-center xl:py-4 cursor-pointer md:hover:bg-[#fd5d00c9] xl:text-2xl py-3 text-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div className="w-full h-auto flex flex-col gap-4 xl:gap-6">
            ...
            <div className="w-full h-auto flex gap-3 items-start md:items-center">
              ...
              <label
                htmlFor="terms"
                className="text-white text-sm xl:text-lg cursor-pointer"
                onClick={() => setRememberMe(!rememberMe)}
              >
