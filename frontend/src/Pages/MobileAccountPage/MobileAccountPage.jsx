      ...
      <div className="p-4 space-y-5 mobile-account-container">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="divide-y divide-gray-200">
            <AccountLink to="/MyOrders" icon={Package}>
              {" "}
              Orders
            </AccountLink>
            <AccountLink to="/account" icon={User}>
              {" "}
              Profile
            </AccountLink>
            <AccountLink to="/wishlist" icon={Heart}>
              {" "}
              Wishlist
            </AccountLink>
            <AccountLink to="/wallet" icon={Wallet}>
              {" "}
              Wallet
            </AccountLink>
            <AccountLink to="/cart" icon={ShoppingCart}>
              {" "}
              Cart
            </AccountLink>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="divide-y divide-gray-200">
            <AccountLink to="/enquiry-history" icon={ClipboardList}>
              {" "}
              Enquiries
            </AccountLink>
            <AccountLink to="/return-tracking" icon={List}>
              {" "}
              Refund
            </AccountLink>
            <AccountLink to="/contact-us" icon={Phone}>
              {" "}
              Contact Us
            </AccountLink>
          </div>
