...
export default function Notifications() {
  const { notifications, unread, markAsRead, markAllAsRead, fetchNotifications } = useNotifications();
  ...
  return (
    <div className="max-w-md mx-auto top-0 mt-[-42px] bg-white shadow-md p-4">
          ...
          notifications.map((notif) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                {notif.description.split(" ").length > 12 && (
                  <button
