...
function MyOrders() {
      ...
      try {
        ...
        if (success && fetchedOrders) {
          const formattedOrders = fetchedOrders
            ...
            ) // Show all orders except cancelled and delivered
            .map((order) => ({
              id: order.id,
  ...
  const OrderTracking = () => {
    ...
    return (
      <div>
        <h2 className="text-gray-800 mb-3 sm:mb-6 text-lg sm:text-3xl font-semibold">
          Order Tracking
        </h2>
        {orders.map((order) => (
          <div
            key={order.id}
            className="bg-white rounded-xl sm:rounded-2xl mb-3 sm:mb-6 shadow-sm border border-gray-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl overflow-hidden"
          >
            <div className="flex flex-col sm:flex-row justify-between items-start p-3 sm:p-6 pb-0 mb-2 sm:mb-5 gap-2 sm:gap-0">
              <div className="flex flex-col gap-0.5 sm:gap-1">
                <div className="text-base sm:text-xl font-bold text-gray-900 tracking-tight">
              ...
              <span
                className={`px-2 sm:px-3.5 py-1 sm:py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider self-start ${
            ...
            <div className="px-3 sm:px-6">
                ...
                <div className="mb-3 sm:mb-5">
                  ...
                  <div className="flex flex-col gap-2 sm:gap-3">
                    {order.order_items?.map((item, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-gray-50 rounded-lg sm:rounded-xl border border-gray-100"
                      >
                        ...
                        <div className="flex-1 flex flex-col gap-0.5">
                          <span className="font-semibold text-gray-900 text-xs sm:text-sm leading-tight">
              ...
              <div className="mt-4 sm:mt-6">
                <h4 className="text-sm sm:text-base font-semibold text-gray-700 mb-3 sm:mb-5">
                  Tracking Progress
                </h4>
                <div className="flex flex-col">
                  {order.trackingSteps.map((step, index) => (
                    <div
                      key={index}
                      className="flex items-start gap-3 sm:gap-4 py-3 sm:py-4 relative border-b border-gray-100 last:border-b-0"
                    >
                      <div className="flex flex-col items-center relative mt-0.5">
                        <div
                          className={`w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full border-2 sm:border-3 transition-all duration-300 z-10 ${
                            step.completed
                        ...
                        {index < order.trackingSteps.length - 1 && (
                          <div
                            className={`w-0.5 h-8 sm:h-10 mt-1 ${
                      ...
                      <div className="flex-1 pt-0.5">
                        <div
                          className={`font-semibold text-xs sm:text-sm mb-1 leading-tight ${
  ...
  const OrderHistory = () => {
    ...
    return (
      <div>
        <h2 className="text-gray-800 mb-4 sm:mb-6 text-lg sm:text-3xl font-semibold">
          Complete Order History & Receipts
        </h2>
        {deliveredOrders.map((order) => (
          <div
            key={order.id}
            className="bg-white rounded-xl sm:rounded-2xl mb-4 sm:mb-6 shadow-sm border border-gray-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl overflow-hidden"
          >
            <div className="flex justify-between items-start p-3 sm:p-6 pb-0 mb-3 sm:mb-5">
              ...
              <span
                className={`px-2 sm:px-3.5 py-1 sm:py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider ${
                  order.status === "shipped"
                    ? "bg-blue-100 text-blue-800"
                    : order.status === "delivered"
                    ? "bg-green-100 text-green-800"
            ...
            <div className="px-3 sm:px-6">
              <div className="flex flex-col gap-3 sm:gap-5">
                <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-blue-50 rounded-lg sm:rounded-xl border border-blue-100">
                  ...
                  <div className="flex flex-col">
                    <h4 className="text-xs sm:text-sm font-semibold text-blue-900 mb-0.5">
                      Return Window
                    </h4>
                    <p className="text-xs sm:text-sm text-blue-700 m-0">
                      25 days remaining
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2 sm:gap-3">
                    {order.order_items?.map((item, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-white rounded-lg sm:rounded-xl border border-gray-200"
                      >
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id={`item-${order.id}-${idx}`}
                            className="w-4 h-4 sm:w-4.5 sm:h-4.5 accent-indigo-500"
                          />
                        </div>
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-200 rounded-md sm:rounded-lg flex items-center justify-center overflow-hidden">
                          {item.products?.image ? (
    ...
    <div>
      ...
      <div className="flex flex-col gap-3 sm:gap-4">
        {notifications.map((notification) => (
          <div
            key={notification.id}
            className={`flex items-center justify-between p-3 sm:p-5 bg-white rounded-lg sm:rounded-xl shadow-sm border-l-4 transition-all duration-300 ${
              notification.read
          ...
          >
            <div className="flex-1">
              <p className="text-gray-800 mb-1 font-medium text-sm sm:text-base leading-tight">
            ...
            {!notification.read && (
              <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-indigo-500 rounded-full"></div>
            )}
          </div>
        ))}
      </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl max-w-2xl w-full max-h-[98vh] sm:max-h-[90vh] overflow-y-auto mx-1 sm:mx-0">
            ...
            <div className="p-3 sm:p-6 space-y-3 sm:space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div>
                  <h4 className="font-semibold text-gray-700 mb-1 sm:mb-2 text-xs sm:text-base">
                    Order ID
                  </h4>
                ...
                <div>
                  ...
                  <span
                    className={`px-2 sm:px-3 py-1 rounded-full text-xs font-semibold uppercase ${
              ...
              <div>
                ...
                <p className="text-gray-900 bg-gray-50 p-2 sm:p-3 rounded-lg text-xs sm:text-base">
