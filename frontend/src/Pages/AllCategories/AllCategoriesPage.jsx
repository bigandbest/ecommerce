...
export default function AllCategoriesPage() {
    ...
    return (
        <div className="sm:hidden fixed top-0 left-0 h-full w-full flex z-40">
            ...
            {/* Main Content (Static) */}
            <div className="flex-1 bg-gray-50 p-4 transition-all duration-300 overflow-y-auto hide-scrollbar">
                <Stores title="Recommended Store" items={Seconddata} mode="grid" forceShow />
                <BbmPicks title="Recommended Store" items={data} mode="grid" forceShow/>
                <Quickyfy title="Quickyfy" items={Thirddata} mode="grid" forceShow/>
            </div>
            ...
            {/* Bottom Drawer Modal */}
            <div
                className={`fixed bottom-0 left-0 w-full h-[90%] bg-white rounded-t-2xl shadow-lg transform transition-transform duration-300 ease-in-out z-50
